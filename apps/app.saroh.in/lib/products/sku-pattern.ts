/**
 * The SKU pattern (#484) for the editor's placeholder and the settings tab's
 * live checks. An identical copy of the API's
 * (`apps/api.saroh.in/src/modules/catalogue/sku-pattern.ts`), which stays the
 * authority; both are tested against the same cases.
 *
