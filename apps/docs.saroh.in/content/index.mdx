...
[Saroh.in](https://saroh.in) is an open-source project built with Next.js, Tailwind CSS, a NestJS API, PostgreSQL, and Better Auth. It is a monorepo maintained with Turborepo.
...
-   [x] Authentication
-   [x] Applicaiton Dashboard.
-   [x] Free subdomain (\*.saroh.site), so that users can preview their published sites.
...
-   [Next.js](https://nextjs.org/), frontend framework for the apps.
-   [NestJS](https://nestjs.com/), the single backend API (`api.saroh.in`).
-   [Tailwind CSS](https://tailwindcss.com/), for styling the application.
-   [PostgreSQL](https://www.postgresql.org/) (AWS RDS), for the database.
-   [Better Auth](https://www.better-auth.com/), for authentication.
-   [Vercel](https://vercel.com/), for hosting the frontends.
...
-   [Nextra](https://nextra.site/), for the docs site deployed on [docs.saroh.in](https://docs.saroh.in).
