...
[Saroh.in](https://saroh.in) is an open-source project built with NextJS, Tailwind CSS, PlanetScale, Next Auth, and Vercel. It is a monorepo maintained with turborepo.
