...
| [backend-auth-and-access.md](backend-auth-and-access.md)             | Touching sessions, organization context, roles, membership, invitations, capability gates, entitlements, staff access or cross-tenant reads |
| [backend-jobs.md](backend-jobs.md)                                   | Enqueueing a background job, or writing or registering a handler                                                                            |
| [backend-billing-and-classes.md](backend-billing-and-classes.md)     | Touching invoices, subscriptions, the renewal job, courses, class packs, or anything that books a session or spends a pack                  |
